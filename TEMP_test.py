...
from youbit.ecc.ecc import ecc_encode
...
# readme_file = os.path.join(readme_file, '/idk/')

print(readme_file)


# with Encoder('E:/test2.jpg') as encoder:
#     print(time()-tik)
#     encoder.encode(crf=18, bpp=2, ecc=64)
#     print(time()-tik)
#     url = encoder.upload(browser='firefox', title='test2.jpg')
#     print(time()-tik)
#     print(url)
...
# with open('E:/testy/intermediate.bin', 'rb') as f:
#     inter = f.read()


# with open('E:/test2.jpg', 'rb') as f:
#     test2 = f.read()

# test2 = ecc_encode(test2, 32)

# print(bytearray(inter)[:50], bytearray(test2)[:50])
# print(len(inter), len(test2))
...
# with Decoder('E:/testy/test2.mp4') as decoder:
#     decoder.decode('E:/testy/test2.jpg', ecc=32, bpp=1)



# with Decoder('https://youtu.be/6IbYKM0ukrc') as decoder:
#     decoder.download()
#     decoder.decode('E:/testy/mycoolfile.jpg')


# downloader = Downloader('https://www.youtube.com/watch?v=6IbYKM0ukrc')
# print(downloader.get_metadata())
# filepath = downloader.download('E:/testy/')
# print(filepath)
